    ...
    <div class="container">
      <div class="row">
        <div class="text-center col-12">
          <h2 style="margin-bottom: 2px;">Privacy policy</h2>
          <p>INFORMATIVA PRIVACY AI SENSI DEL REGOLAMENTO UE 679/2016 (“GDPR”)</p>
        </div>
        <div class="col-12">
          <br>
          <br>
          <p>La presente Informativa sulla privacy si applica quando l'utente utilizza i servizi di collab.42web.io (siti Web, applicazioni mobili e altri prodotti e servizi online) o interagisce in altro modo con noi. Questa Informativa può subire modifiche, quando ciò accade gli utenti saranno informati. Invitiamo gli utenti a rivedere regolarmente questa Informativa sulla privacy per rimanere informati sulle nostre policy.</p>
        </div>
      </div>
      ...
      <div id="dataCollection" class="row">
        ...
        <div class="col-12">
          <div id="dataSection2" class="row">
            <div class="col-12">
              <h4 style="color: rgb(21, 133, 224);">Informazioni che raccogliamo automaticamente quando utilizzi i nostri servizi</h4>
            </div>
            <div class="col-12">
      ...
      <div id="informationWe" class="row">
        <div class="col-12">
          <h4 style="color: rgb(21, 133, 224);">Informazioni che raccogliamo da altre fonti</h4>
        </div>
        <div class="col-12">
          <p>Otteniamo informazioni da fonti di terze parti. Ad esempio, i dati relativi ai log come indirizzo IP, sistema operativo, tipo di browser e cookie sono raccolti anche per scopi di amministrazione e monitoraggio del sistema, in particolare per combattere SPAM o malware. Si tratta di dati statistici sulle azioni e sui modelli di navigazione dei nostri utenti. Utilizzeremo questi dati in modo anonimo per migliorare e valutare la nostra gamma di servizi.</p>
        </div>
        <div class="col-12">
          <p>Quando si utilizzano i servizi basati sulla posizione, collab.42web.io, raccoglie ed elabora informazioni sulla posizione del dispositivo di ricezione. Questo viene utilizzato in particolare per migliorare e personalizzare il nostro servizio.</p>
        </div>
      </div>
      <div id="purposeOfTheProcessing" class="row">
        <div class="col-12">
        ...
        <div class="col-12">
          ...
          <p>Utilizzeremo i dati personali anche per:</p>
          <ul>
            <li>verificare l’identità e convalidare la registrazione agli applicativi;</li>
            <li>consentire di accedere e/o contribuire al progetto di mappatura collaborativa e l’utilizzo delle funzionalità interattive del nostro servizio, quando l’utente sceglie di farlo;</li>
          ...
          <p>Quando l’utente si registra a collab.42web.io, chiediamo il consenso al trattamento dei tuoi dati come descritto sopra. Facciamo affidamento su questo consenso come base legale su cui raccogliamo e utilizziamo i tuoi dati personali.</p>
        </div>
      </div>
      <div id="infromationSharing" class="row">
        <div class="col-12">
          <h4 style="color: rgb(21, 133, 224);">Condivisione di informazioni</h4>
        </div>
        <div class="col-12">
          <p>Condividiamo informazioni su di te nelle seguenti circostanze o come altrimenti descritto in questa politica.</p>
          <p>collab.42web.io condivide le informazioni dell'utente con fornitori, fornitori di servizi e affiliati che forniscono servizi, come società che assistono con hosting web, elaborazione dati, consegna e-mail e servizio clienti. Tale condivisione avviene tra collab.42web.io e le nostre attuali e future controllanti, affiliate e sussidiarie e altre società sotto il controllo e la proprietà comuni.</p>
          <p>Condividiamo le informazioni se riteniamo che la divulgazione sia conforme a, o richiesta da, qualsiasi legge o procedimento legale applicabile, comprese le richieste legittime da parte delle autorità pubbliche per soddisfare i requisiti di sicurezza nazionale o di applicazione della legge.</p>
          <p>Condividiamo le informazioni se riteniamo che le tue azioni siano incoerenti con i nostri accordi o politiche per gli utenti, o se riteniamo che sia necessario proteggere i diritti, la proprietà e la sicurezza di collab.42web.io o di altri.</p>
      ...
      <div id="placeOfDataStorage" class="row">
        <div class="col-12">
          <h4 style="color: rgb(21, 133, 224);">Luogo di conservazione dei dati</h4>
        </div>
        <div class="col-12">
          <p>I dati personali dell’utente saranno conservati in server collocati a Newcastle, UK. I dati personali dell’utente potrebbero essere trasferiti in un paese diverso da quello in cui l’utente si trova. Per ottenere ulteriori informazioni sul luogo del trattamento l’Utente può fare riferimento alla sezione relativa ai dettagli sul trattamento dei Dati Personali.</p>
        </div>
        <div class="col-12">
          <p>L’utente ha diritto a ottenere informazioni in merito alla base giuridica del trasferimento di Dati al di fuori dell’Unione Europea o ad un’organizzazione internazionale di diritto internazionale pubblico o costituita da due o più paesi, come ad esempio l’ONU, nonché in merito alle misure di sicurezza adottate dal Titolare per proteggere i dati.</p>
        </div>
        <div class="col-12">
          <p>L’Utente può verificare se abbia luogo uno dei trasferimenti appena descritti esaminando la sezione relativa ai dettagli sul trattamento di Dati Personali o chiedere informazioni al Titolare contattandolo agli estremi riportati in apertura.</p>
        </div>
      </div>
      <div id="storagePeriod" class="row">
        <div class="col-12">
          <h4 style="color: rgb(21, 133, 224);">Periodo di conservazione</h4>
        </div>
        <div class="col-12">
      ...
      <div id="userRights" class="row">
        <div class="col-12">
          <h4 style="color: rgb(21, 133, 224);">I diritti degli utenti</h4>
        </div>
        <div class="col-12">
          <p>Secondo il Regolamento generale sulla protezione dei dati (GDPR) come utente hai il diritto di:</p>
          <ul>
            <li>ottenere la cessazione del trattamento nei casi in cui i suoi dati personali siano trattati per fini di marketing diretto, anche in relazione a servizi identici a quelli già erogati dalla nostra società (c.d. diritto di opposizione);</li>
            <li>ottenere informazioni in relazione alle finalità per cui i dati personali sono trattati, al periodo del trattamento e ai soggetti cui i dati sono comunicati (c.d. diritto di accesso); </li>
            <li>ottenere la rettifica o integrazione dei dati personali inesatti che riguardano l’Interessato (c.d. diritto di rettifica);</li>
            <li>ottenere la cancellazione dei dati personali che riguardano l’Interessato; </li>
            <li>ottenere che i dati personali che riguardano l’Interessato siano solo conservati, senza che di essi sia fatto altro uso, nei seguenti casi: l’Interessato contesti l’esattezza dei dati personali, per il periodo necessario a consentirci di verificare l’esattezza di tali dati personali; i dati personali siano necessari per l’accertamento, l’esercizio o la difesa di un diritto in sede giudiziaria; l’Interessato si sia opposto al trattamento e si sia in attesa della verifica in merito all’eventuale prevalenza dei nostri motivi legittimi al trattamento rispetto a quelli dell’interessato (c.d. diritto di limitazione);</li>
            <li>ricevere in un formato di uso comune, leggibile da dispositivo automatico e interoperabile, i dati personali che riguardano l’Interessato, se essi siano trattati in forza di contratto o sulla base del Suo consenso (c.d. diritto di portabilità).</li>
          </ul>
        </div>
        <div class="col-12">
      ...
      <div id="keepYourPersonal" class="row">
        <div class="col-12">
          <h4 style="color: rgb(21, 133, 224);">Mantenere le tue informazioni personali al sicuro</h4>
        </div>
        <div class="col-12">
          <p>Disponiamo di adeguate misure di sicurezza per impedire la perdita accidentale, l'utilizzo o l'accesso alle informazioni personali in modo non autorizzato. Disponiamo inoltre di procedure per far fronte a qualsiasi sospetta violazione della sicurezza dei dati. Informeremo te e qualsiasi autorità di regolamentazione applicabile di una sospetta violazione della sicurezza dei dati laddove siamo legalmente obbligati a farlo.</p>
        </div>
      </div>
    </div>
    <div class="row">
        ...
        <div class=" dark">
          <div class="container">
            ...
            <div id="Activities" class="row">
              <div class="col-12">
                <br>
                <h4 style="color: rgb(21, 133, 224);">Attività strettamente necessarie a garantire il funzionamento di questa Applicazione e la fornitura del Servizio</h4>
            ...
            <div class="row">
              <div class="col-12">
                <br>
                <h4 style="color: rgb(21, 133, 224);">Interazioni e funzionalità semplici</h4>
