        ...
        public function process(ServerRequestInterface $request, RequestHandlerInterface $next): ResponseInterface
        {
            ...
            if ($method == 'POST' && in_array($path, ['login', 'register', 'password'])) {
                ...
                if ($path == 'register') {
                    ...
                    $firstName = isset($body->first_name) ? $body->first_name : '';
                    $lastName = isset($body->last_name) ? $body->last_name : '';
                    $email = isset($body->email) ? $body->email : '';
                    $terms = isset($body->terms) ? 'yes' : '';
...
namespace Tqdev\PhpCrudApi {
    ...
    $userFields = array("first_name"=>"first_name", "last_name"=>"last_name", "email"=>"email", "terms"=>"terms");
    ...
    $config = new Config([
        ...
        'cors.allowedOrigins' => '*',
        'cors.allowMethods' => 'OPTIONS, GET, PUT, POST, DELETE, PATCH',
